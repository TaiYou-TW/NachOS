...
//	"size" -- the nu of bytes to be written (1, 2, or 4)
...
//------    ----------------------------------------------------------------
// Machine::    Translatevirtual address into a physical address, using page table or a TLB.  Check for alignment and all sorts
